...
import com.chloemlla.aura.data.model.normalizeCreatorProfileInput
...
internal fun filterCreatorUploadsForBlockedUsers(
    ...
    if (blockedCreatorIds.isEmpty()) {
        ...
        uploads.filterNot { com.chloemlla.aura.data.model.isCommunityUserBlocked(it.creatorId, it.creatorId, blockedCreatorIds) }
    }
