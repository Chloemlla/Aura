...
class SettingsViewModel @Inject constructor(
    ...
    private val libraryExporter: com.chloemlla.aura.service.LibraryExporter,
    private val aiWallpaperRepository: com.chloemlla.aura.data.repository.AiWallpaperRepository,
    ...
    fun setSoundProfilesEnabled(enabled: Boolean) = viewModelScope.launch {
        ...
        if (enabled) {
            com.chloemlla.aura.service.SoundProfileWorker.schedule(context)
        } else {
            com.chloemlla.aura.service.SoundProfileWorker.cancel(context)
        }
    }
    ...
    fun setWallpaperPackEnabled(enabled: Boolean) = viewModelScope.launch {
        ...
        if (enabled) {
            com.chloemlla.aura.service.WallpaperPackWorker.schedule(context)
        } else {
            com.chloemlla.aura.service.WallpaperPackWorker.cancel(context)
        }
    }
