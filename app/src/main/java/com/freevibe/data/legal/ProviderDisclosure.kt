...
val providerDisclosures = listOf(
    ...
    ProviderDisclosure(
        ...
        content = "Legacy placeholder-photo attribution",
        ...
        storeDisclosure = "Legacy attribution only for older saved placeholder images.",
    ),
    ProviderDisclosure(
    ...
    ProviderDisclosure(
        ...
        content = "Picture of the Day wallpapers",
        status = ProviderStatus.ACTIVE,
        ...
        attribution = "Preserve author, license, and source-page metadata on browse, detail, and saved items.",
        cachePolicy = "Cache the daily featured image for Discover freshness and offline continuity.",
        userActions = "Browse, favorite, apply, and download with visible author/license context.",
        storeDisclosure = "Third-party commons source providing a daily featured image.",
    ),
    ProviderDisclosure(
        source = ContentSource.INTERNET_ARCHIVE,
        displayName = "Internet Archive",
        content = "Legacy audio attribution",
        status = ProviderStatus.LEGACY,
        ...
        storeDisclosure = "Legacy attribution only for older saved audio.",
    ),
    ProviderDisclosure(
        ...
        cachePolicy = "Cache public Atom metadata for two hours, honor cooldowns, and keep stale results available during provider errors.",
        userActions = "Browse, favorite, download, apply, and share links with clear Reddit attribution.",
        storeDisclosure = "Third-party community media from Reddit public Atom feeds.",
    ),
    ProviderDisclosure(
    ...
    ProviderDisclosure(
        ...
        content = "Legacy saved and bundled-source sound attribution",
        status = ProviderStatus.LEGACY,
        ...
        cachePolicy = "Keep legacy attribution and curated source metadata; no new Freesound feed is requested.",
        userActions = "View or remove saved records and open source details while keeping attribution visible.",
        storeDisclosure = "Legacy attribution only for older saved and bundled-source sounds.",
    ),
    ProviderDisclosure(
        source = ContentSource.JAMENDO,
        displayName = "Jamendo",
        content = "Legacy music attribution",
        status = ProviderStatus.LEGACY,
        ...
        storeDisclosure = "Legacy attribution only for older saved music.",
    ),
    ProviderDisclosure(
    ...
    ProviderDisclosure(
        ...
        content = "Legacy Creative Commons music attribution",
        status = ProviderStatus.LEGACY,
        ...
        userActions = "Existing saved items can remain visible with provenance.",
        storeDisclosure = "Legacy attribution only for older saved Creative Commons music.",
    ),
    ProviderDisclosure(
    ...
    ProviderDisclosure(
        ...
        displayName = "Klipy",
        content = "Legacy animated-media attribution",
        status = ProviderStatus.LEGACY,
        ...
        cachePolicy = "No active feed; retained records should be local/user-saved only.",
        userActions = "Existing saved items can remain visible with provenance.",
        storeDisclosure = "Legacy attribution only for older saved animated media.",
    ),
    ProviderDisclosure(
        source = ContentSource.SOUNDCLOUD,
        displayName = "SoundCloud",
        content = "Legacy sound attribution",
        status = ProviderStatus.LEGACY,
        ...
        userActions = "Existing saved items can remain visible with provenance.",
        storeDisclosure = "Legacy attribution only for older saved sounds.",
    ),
    ProviderDisclosure(
    ...
    ProviderDisclosure(
        ...
        displayName = "Aura Originals",
        content = "Original bundled sounds",
        status = ProviderStatus.ACTIVE,
        termsUrl = "https://github.com/SysAdminDoc/Aura/blob/main/docs/aura-originals-license.md",
        licenseSummary = "Original waveform synthesis dedicated under CC0 1.0",
        attribution = "Attribution is appreciated but not required by CC0.",
        cachePolicy = "Audio and metadata ship in app resources; no network cache is needed.",
        userActions = "Preview, favorite, edit, apply, download, and share.",
        storeDisclosure = "First-party synthesized audio included under CC0 1.0.",
    ),
...
val providerRuntimeControls = listOf(
    ...
    ProviderRuntimeControl(
        source = ContentSource.WIKIMEDIA,
        surfaces = "Discover feed secondary daily-image source.",
        status = ProviderRuntimeControlStatus.COVERED,
        currentControl = "Wikimedia Picture of the Day is fetched by WallpaperRepository as a Discover secondary source under the shared secondary-source budget.",
        disabledBehavior = "Not fetched when the Discover feed excludes secondary sources or when api.wikimedia.org is unreachable; saved rows keep author/license attribution.",
        followUp = "None.",
    ),
    ProviderRuntimeControl(
        source = ContentSource.INTERNET_ARCHIVE,
    ...
    ProviderRuntimeControl(
        source = ContentSource.REDDIT,
        surfaces = "Wallpaper Discover, Reddit wallpaper browsing, video browsing, and rotation.",
        status = ProviderRuntimeControlStatus.COVERED,
        currentControl = "Settings exposes a Reddit source switch shared by wallpaper, video, and rotation fetches.",
        disabledBehavior = "New Reddit requests stop while cached and saved items keep attribution and unavailable-source states.",
        followUp = "None.",
    ),
    ProviderRuntimeControl(
        source = ContentSource.NASA,
    ...
    ProviderRuntimeControl(
        ...
        status = ProviderRuntimeControlStatus.COVERED,
        currentControl = "No active browsing tab uses Freesound; old attribution metadata is retained for compatibility.",
    ...
    ProviderRuntimeControl(
        ...
        status = ProviderRuntimeControlStatus.COVERED,
        currentControl = "Settings exposes a Pixabay provider-enabled flag and user API key field; photo and video metadata requests use 24-hour fresh-cache paths and 429 backoff.",
