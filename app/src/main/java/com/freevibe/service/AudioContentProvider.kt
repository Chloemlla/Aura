...
class AudioContentProvider : ContentProvider() {
    ...
    private fun isTrustedCaller(): Boolean {
        ...
        if (!allowed && com.freevibe.BuildConfig.DEBUG) {
    ...
    companion object {
        ...
        private val URI_MATCHER = UriMatcher(UriMatcher.NO_MATCH).apply {
            addURI("com.freevibe.audioprovider", "sound/*", SOUND)
            addURI("com.freevibe.audioprovider", "sound/*/preview", SOUND_PREVIEW)
            addURI("com.freevibe.audioprovider", "sound/*/download", SOUND_DOWNLOAD)
            addURI("com.freevibe.audioprovider", "category/*", CATEGORY)
        }
