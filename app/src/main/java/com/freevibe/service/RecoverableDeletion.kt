...
data class TrashedDownload(
    ...
    val sourceAvailability: String = com.freevibe.data.model.SOURCE_AVAILABILITY_AVAILABLE,
    val sourceAvailabilityReason: String? = null,
    val localMediaStatus: String = com.freevibe.data.model.LocalMediaStatus.AVAILABLE,
