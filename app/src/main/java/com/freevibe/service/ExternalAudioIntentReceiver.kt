 ...
 *
 * ### Play a sound by ID
 * - Action: `com.freevibe.action.PLAY_SOUND`
 * - Extra `com.freevibe.extra.SOUND_ID` (String) — the stable key of the sound to play
 *   (e.g. `"SOUND::BUNDLED::bundled_ringtone_01"`)
 * - Extra `com.freevibe.extra.VOLUME` (Float, optional) — volume 0.0–1.0, default 1.0
 *
 * Example (Tasker / adb shell):
 * ```
 * am broadcast -a com.freevibe.action.PLAY_SOUND \
 *   --es com.freevibe.extra.SOUND_ID "SOUND::BUNDLED::bundled_ringtone_01"
 * ```
 *
 * ### Play a random sound from a category
 * - Action: `com.freevibe.action.PLAY_RANDOM`
 * - Extra `com.freevibe.extra.CATEGORY` (String, optional) — "ringtone", "notification", "alarm", or "all" (default)
 *
 * ### Stop playback
 * - Action: `com.freevibe.action.STOP_PLAYBACK`
 *
 * ### Set volume
 * - Action: `com.freevibe.action.SET_VOLUME`
 * - Extra `com.freevibe.extra.VOLUME` (Float) — 0.0–1.0
 *
 * ## Security
...
class ExternalAudioIntentReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        /** Actions */
        const val ACTION_PLAY_SOUND = "com.freevibe.action.PLAY_SOUND"
        const val ACTION_PLAY_RANDOM = "com.freevibe.action.PLAY_RANDOM"
        const val ACTION_STOP_PLAYBACK = "com.freevibe.action.STOP_PLAYBACK"
        const val ACTION_SET_VOLUME = "com.freevibe.action.SET_VOLUME"

        /** Extras */
        const val EXTRA_SOUND_ID = "com.freevibe.extra.SOUND_ID"
        const val EXTRA_CATEGORY = "com.freevibe.extra.CATEGORY"
        const val EXTRA_VOLUME = "com.freevibe.extra.VOLUME"
    }
}
