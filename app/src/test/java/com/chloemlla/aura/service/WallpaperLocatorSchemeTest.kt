...
class WallpaperLocatorSchemeTest {
    ...
    @Test fun `file URI from File toURI classified as file`() {
        // File.toURI().toString() can yield "file:/data/data/com.chloemlla.aura/files/ai_wallpapers/abc.png"
        assertEquals(Kind.FILE, classify("file:/data/data/com.chloemlla.aura/files/ai_wallpapers/abc.png"))
    }
    ...
    @Test fun `absolute path classified as path`() {
        assertEquals(Kind.PATH, classify("/data/user/0/com.chloemlla.aura/files/wp.png"))
    }
