...
class WallpapersViewModelTest {
    ...
    fun `toggleFavorite deletes generated wallpaper file when removing saved AI wallpaper`() = runTest(dispatcher) {
        ...
        val wallpaper = wallpaper(
            ...
            fullUrl = "file:///data/user/0/com.chloemlla.aura/files/ai_wallpapers/generated-1.png",
        ).copy(
            thumbnailUrl = "file:///data/user/0/com.chloemlla.aura/files/ai_wallpapers/generated-1.png",
        )
    ...
    fun `resolveWallpaper uses type-scoped favorite lookup when raw ids collide across content types`() = runTest(dispatcher) {
        ...
        coEvery { favoritesRepo.getLatestById(any()) } returns com.chloemlla.aura.data.model.FavoriteEntity(
            id = "shared_raw",
        ...
        coEvery { favoritesRepo.getLatestByIdAndType("shared_raw", "WALLPAPER") } returns com.chloemlla.aura.data.model.FavoriteEntity(
            id = "shared_raw",
