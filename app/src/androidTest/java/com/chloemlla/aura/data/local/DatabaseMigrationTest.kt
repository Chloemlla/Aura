    ...
    fun migrate14ToCurrent_preservesRepresentativeRowsAndBackfillsDefaults() {
        ...
        helper.runMigrationsAndValidate(
            ...
            *migrationsFrom(14),
            ...
            assertEquals(0, countRows(db, "rotation_exclusions"))
        ...
        SQLiteDatabase.openDatabase(context.getDatabasePath(TEST_DB).path, null, SQLiteDatabase.OPEN_READWRITE).use { db ->
            db.execSQL(
                ...
                INSERT INTO favorites (
                    ...
                    1700000000, '/data/user/0/com.chloemlla.aura/files/offline/shared.jpg',
            ...
            db.execSQL(
                ...
                INSERT INTO downloads (
                    ...
                    '/data/user/0/com.chloemlla.aura/files/downloads/tone.mp3',
