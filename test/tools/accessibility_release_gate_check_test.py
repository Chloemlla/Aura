...
class AccessibilityReleaseGateCheckTest(unittest.TestCase):
    ...
    def test_rejects_missing_automated_api(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            test_path = repo / "app/src/androidTest/java/com/chloemlla/aura/ui/accessibility/AccessibilityReleaseGateTest.kt"
    ...
    def test_every_screen_destination_is_covered_or_excused(self) -> None:
        ...
        screen_source = (
            REPO_ROOT / "app/src/main/java/com/chloemlla/aura/ui/navigation/Screen.kt"
    ...
    def test_rejects_a_new_destination_with_no_coverage_entry(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            repo = copy_required_tree(Path(tmpdir))
            screen = repo / "app/src/main/java/com/chloemlla/aura/ui/navigation/Screen.kt"
            screen.write_text(
...
def copy_required_tree(destination: Path) -> Path:
    paths = [
        ...
        "app/src/main/java/com/chloemlla/aura/ui/qa/ProductionRouteState.kt",
        "app/src/androidTest/java/com/chloemlla/aura/ui/accessibility/AccessibilityReleaseGateTest.kt",
        ...
        "app/src/main/java/com/chloemlla/aura/ui/navigation/Screen.kt",
    ]
