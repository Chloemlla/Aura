    ...
    *,
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if include_foss_contract:
            ...
            navigation_path = repo / "app/src/main/java/com/chloemlla/aura/ui/FreeVibeRoot.kt"
            navigation_path.parent.mkdir(parents=True, exist_ok=True)
            navigation_path.write_text(
                "generatedWallpaperRoute(navController)\n",
                encoding="utf-8",
            )
            full_route_path = repo / "app/src/full/java/com/chloemlla/aura/ui/GeneratedWallpaperRoute.kt"
            full_route_path.write_text(
                "composable(Screen.AiWallpaper.route)\nAiWallpaperScreen(\n",
                encoding="utf-8",
            )
            foss_route_path = repo / "app/src/foss/java/com/chloemlla/aura/ui/GeneratedWallpaperRoute.kt"
            foss_route_path.parent.mkdir(parents=True, exist_ok=True)
            foss_route_path.write_text(
                foss_route_source,
                encoding="utf-8",
            )
            wallpapers_path = repo / "app/src/main/java/com/chloemlla/aura/ui/screens/wallpapers/WallpapersScreen.kt"
            ...
            services_path = repo / "app/src/main/java/com/chloemlla/aura/ui/screens/settings/SettingsServicesSection.kt"
            ...
            full_settings_path = repo / "app/src/full/java/com/chloemlla/aura/ui/screens/settings/GeneratedWallpaperProviderSettings.kt"
            ...
            foss_settings_path = repo / "app/src/foss/java/com/chloemlla/aura/ui/screens/settings/GeneratedWallpaperProviderSettings.kt"
        ...
        if include_update_consent:
            manager_path = repo / "app/src/main/java/com/chloemlla/aura/service/YtDlpUpdateManager.kt"
            ...
            settings_source_path = repo / "app/src/main/java/com/chloemlla/aura/ui/screens/settings/SettingsSoundSection.kt"
        ...
        try:
            ...
            fdroid_preflight.YTDLP_MANAGER = repo / "app/src/main/java/com/chloemlla/aura/service/YtDlpUpdateManager.kt"
            fdroid_preflight.YTDLP_SETTINGS = repo / "app/src/main/java/com/chloemlla/aura/ui/screens/settings/SettingsSoundSection.kt"
            fdroid_preflight.STRINGS_XML = repo / "app/src/main/res/values/strings.xml"
            fdroid_preflight.ROOT_NAVIGATION = repo / "app/src/main/java/com/chloemlla/aura/ui/FreeVibeRoot.kt"
            fdroid_preflight.WALLPAPERS_SCREEN = repo / "app/src/main/java/com/chloemlla/aura/ui/screens/wallpapers/WallpapersScreen.kt"
            fdroid_preflight.SERVICES_SCREEN = repo / "app/src/main/java/com/chloemlla/aura/ui/screens/settings/SettingsServicesSection.kt"
            fdroid_preflight.FULL_GENERATED_ROUTE = repo / "app/src/full/java/com/chloemlla/aura/ui/GeneratedWallpaperRoute.kt"
            fdroid_preflight.FOSS_GENERATED_ROUTE = repo / "app/src/foss/java/com/chloemlla/aura/ui/GeneratedWallpaperRoute.kt"
            fdroid_preflight.FULL_GENERATED_SETTINGS = repo / "app/src/full/java/com/chloemlla/aura/ui/screens/settings/GeneratedWallpaperProviderSettings.kt"
            fdroid_preflight.FOSS_GENERATED_SETTINGS = repo / "app/src/foss/java/com/chloemlla/aura/ui/screens/settings/GeneratedWallpaperProviderSettings.kt"
...
""",
            main_profile_extra="Lcom/chloemlla/aura/data/remote/stability/StabilityAiApi;\n",
        )
