...
STABLE_MODEL = """package com.chloemlla.aura.data.model
...
UNSTABLE_MODEL = """package com.chloemlla.aura.data.model
...
GRID_SCREEN = """package com.chloemlla.aura.ui.screens.wallpapers
