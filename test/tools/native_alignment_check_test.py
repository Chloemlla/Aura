...
class MediaStackMigrationEvidenceTest(unittest.TestCase):
    def setUp(self):
        ...
        for source_path in (
            "app/src/main/java/com/chloemlla/aura/service/AudioTrimmer.kt",
            "app/src/main/java/com/chloemlla/aura/ui/screens/videowallpapers/VideoCropScreen.kt",
        ):
            ...
            "retainedFfmpegConsumers": [
                {
                    ...
                    "sourcePath": "app/src/main/java/com/chloemlla/aura/service/AudioTrimmer.kt",
                    "mode": "fallback",
                    "operations": ["MP3 encode"],
                },
                {
                    "id": "video-crop-export",
                    "sourcePath": "app/src/main/java/com/chloemlla/aura/ui/screens/videowallpapers/VideoCropScreen.kt",
                    "mode": "direct",
