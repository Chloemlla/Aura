...
YTDLP_MANAGER = ROOT / "app" / "src" / "main" / "java" / "com" / "chloemlla" / "aura" / "service" / "YtDlpUpdateManager.kt"
YTDLP_SETTINGS = ROOT / "app" / "src" / "main" / "java" / "com" / "chloemlla" / "aura" / "ui" / "screens" / "settings" / "SettingsSoundSection.kt"
STRINGS_XML = ROOT / "app" / "src" / "main" / "res" / "values" / "strings.xml"
ROOT_NAVIGATION = ROOT / "app" / "src" / "main" / "java" / "com" / "chloemlla" / "aura" / "ui" / "FreeVibeRoot.kt"
WALLPAPERS_SCREEN = ROOT / "app" / "src" / "main" / "java" / "com" / "chloemlla" / "aura" / "ui" / "screens" / "wallpapers" / "WallpapersScreen.kt"
SERVICES_SCREEN = ROOT / "app" / "src" / "main" / "java" / "com" / "chloemlla" / "aura" / "ui" / "screens" / "settings" / "SettingsServicesSection.kt"
FULL_GENERATED_ROUTE = ROOT / "app" / "src" / "full" / "java" / "com" / "chloemlla" / "aura" / "ui" / "GeneratedWallpaperRoute.kt"
FOSS_GENERATED_ROUTE = ROOT / "app" / "src" / "foss" / "java" / "com" / "chloemlla" / "aura" / "ui" / "GeneratedWallpaperRoute.kt"
FULL_GENERATED_SETTINGS = ROOT / "app" / "src" / "full" / "java" / "com" / "chloemlla" / "aura" / "ui" / "screens" / "settings" / "GeneratedWallpaperProviderSettings.kt"
FOSS_GENERATED_SETTINGS = ROOT / "app" / "src" / "foss" / "java" / "com" / "chloemlla" / "aura" / "ui" / "screens" / "settings" / "GeneratedWallpaperProviderSettings.kt"
